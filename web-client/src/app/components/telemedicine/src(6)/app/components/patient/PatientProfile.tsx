...
export function PatientProfile() {
  const [activeTab, setActiveTab] = useState<'profile' | 'vault' | 'emergency'>('profile');
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm text-gray-600 mb-2">Provider</label>
                    <div className="text-gray-900">{patientInfo.insurance.provider}</div>
                  </div>
                  <div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="p-6">
              ...
              <div className="mt-6 p-6 border-2 border-dashed border-gray-300 rounded-lg text-center cursor-pointer hover:border-blue-400 hover:bg-blue-50 transition-colors">
                ...
                <p className="text-sm text-gray-500">Supported: PDF, JPG, PNG (Max 50MB)</p>
              </div>
            </div>
          </div>
        )}
