          ...
          <div className="col-span-2 bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={revenueData}>
                ...
                <Line type="monotone" dataKey="payouts" stroke="#3b82f6" strokeWidth={2} name="Provider Payouts" />
              </LineChart>
            </ResponsiveContainer>
          </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200">
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-xl">Provider Payouts</h2>
            </div>
            <div className="divide-y divide-gray-200">
              {providerPayouts.map((payout, idx) => (
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="pt-6 border-t border-gray-200">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600">Provider Payouts</span>
